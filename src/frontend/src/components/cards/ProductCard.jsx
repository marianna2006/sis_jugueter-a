...
export default function ProductCard({ id, name, price, image, oldPrice }) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-lg shadow-md overflow-hidden w-full max-w-xs transition duration-300 hover:scale-105 hover:shadow-xl cursor-pointer flex flex-col h-full"
    >
      <img
        src={image}
        alt={name}
