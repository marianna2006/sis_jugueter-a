...
export default function PopularSection() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost:3000/api/products/filter/popular");
  ...
  return (
    <div className="my-12 px-4">
      <h2 className="text-4xl font-bold text-center mb-2 text-primary">¡Productos Populares!</h2>
      <p className="text-center text-2xl text-testSecondary mb-8">Los juguetes más populares y valorados</p>
